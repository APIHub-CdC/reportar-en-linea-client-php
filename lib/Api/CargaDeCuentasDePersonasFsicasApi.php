...
class CargaDeCuentasDePersonasFsicasApi
{
    ...
    public function registrar($x_api_key, $username, $password, $request)
    {
        list($response) = $this->registrarWithHttpInfo($x_api_key, $username, $password, $request);
        return $response;
    }
    ...
    public function registrarAsync($x_api_key, $username, $password, $request)
    {
        return $this->registrarAsyncWithHttpInfo($x_api_key, $username, $password, $request)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    protected function registrarRequest($x_api_key, $username, $password, $request)
    {
        ...
        if ($username === null || (is_array($username) && count($username) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $username when calling registrar'
            );
        }
        if ($password === null || (is_array($password) && count($password) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $password when calling registrar'
            );
        }
