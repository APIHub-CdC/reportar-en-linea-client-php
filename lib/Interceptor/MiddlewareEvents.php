...
use \ReportarEnLinea\Client\Interceptor\KeyHandler;
use \ReportarEnLinea\Client\Interceptor\MyLogger;
use \ReportarEnLinea\Client\Model\Errors;
use \ReportarEnLinea\Client\Model\Error;

class MiddlewareEvents
{
    
    function __construct(\ReportarEnLinea\Client\Interceptor\KeyHandler $signer)
    {
        $this->signer = $signer;
...
function build_error($code, $message){
    $error = new \ReportarEnLinea\Client\Model\Error([
        "code" => $code,
        "message" => $message
    ]);
    $errors = new \ReportarEnLinea\Client\Model\Errores(["errors" => [$error]]);
